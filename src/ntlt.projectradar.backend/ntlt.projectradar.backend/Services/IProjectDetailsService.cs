...
{
    Task<ProjectDetails> CreateProjectDetailsAsync(ProjectDetails projectDetails, CancellationToken cancellationToken = default);
    ...
    Task<ProjectDetails?> UpdateProjectDetailsAsync(ProjectDetails projectDetails, CancellationToken cancellationToken = default);    Task<bool> DeleteProjectDetailsAsync(Guid id, CancellationToken cancellationToken = default);
    Task<List<ProjectDetails>> GetProjectDetailsByEmailIdAsync(Guid emailId, CancellationToken cancellationToken = default);
