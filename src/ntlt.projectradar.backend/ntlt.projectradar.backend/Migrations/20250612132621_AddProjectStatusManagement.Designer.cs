...
namespace ntlt.projectradar.backend.Migrations
{
    ...
    [Migration("20250612132621_AddProjectStatusManagement")]
    partial class AddProjectStatusManagement
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ntlt.projectradar.backend.Models.ProjectDetails", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("ntlt.projectradar.backend.Models.ProjectEmails", b =>
                {
                    ...
                    b.HasKey("ProjectId", "EmailId");

                    b.ToTable("ProjectEmails");
                });

            modelBuilder.Entity("ntlt.projectradar.backend.Models.ProjectStatusHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
